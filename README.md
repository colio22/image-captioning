...
from a publically available Google Drive file. To take advantage of this option, take the following steps:
  1. Go to [the public Google Drive folder](https://drive.google.com/drive/folders/1_T0DvSwkLtv0scrs5fsz4YX8NYyBJZz9?usp=sharing)
  2. Click the three ellipsis next to the `coco_detections.hdf5` file
  3. Select "Make a Copy"
  4. Copy the file to an easily accessible location on your own Google Drive.
